...
export type GoogleCompletionPrompt = {
    content: string;
} & Variables;
...
export type GoogleRequestInput = GoogleCompletionRequestInput | GoogleChatRequestInput;
...
export type GoogleRequestOutput = GoogleCompletionRequestOutput | GoogleChatRequestOutput;
export {};
