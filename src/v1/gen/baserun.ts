...
export interface Span {
  ...
  /**
   * @deprecated
   * @generated from protobuf field: optional string functions = 18 [deprecated = true];
   */
  functions?: string; // JSONified array<map<str, any>>
  /**
   * @deprecated
   * @generated from protobuf field: optional string function_call = 19 [deprecated = true];
   */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional string api_type */ 17:
          ...
          break;
        case /* optional string functions = 18 [deprecated = true];*/ 18:
          message.functions = reader.string();
          break;
        case /* optional string function_call = 19 [deprecated = true];*/ 19:
          message.functionCall = reader.string();
          break;
