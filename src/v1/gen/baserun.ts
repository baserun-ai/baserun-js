...
export interface Run {
  ...
  sessionId: string;
  /**
   * @generated from protobuf field: optional string environment = 12;
   */
  environment?: string;
}
/**
...
export interface Span {
  ...
  bestOf?: number;
  /**
   * @generated from protobuf field: optional string x_request_id = 47;
   */
  xRequestId?: string;
  /**
...
/**
 * @generated from protobuf message baserun.v1.CompletionAnnotations
 */
export interface CompletionAnnotations {
  /**
...
export interface Template {
  ...
  /**
   * @generated from protobuf field: optional baserun.v1.TemplateVersion active_version = 5;
   */
...
export interface TemplateVersion {
  ...
  tag: string;
  /**
   * @generated from protobuf field: optional string parameter_definition = 4;
   */
  parameterDefinition?: string; // Deprecated
  /**
   * @generated from protobuf field: optional string template_string = 5;
   */
  templateString?: string; // Deprecated
  /**
   * @generated from protobuf field: repeated baserun.v1.TemplateMessage template_messages = 6;
   */
  templateMessages: TemplateMessage[];
}
/**
 * @generated from protobuf message baserun.v1.TemplateMessage
 */
export interface TemplateMessage {
  ...
  role: string;
  /**
   * @generated from protobuf field: int32 order_index = 5;
   */
  orderIndex: number;
}
/**
...
export interface SubmitTemplateVersionResponse {
  ...
  templateVersion?: TemplateVersion;
  /**
   * @generated from protobuf field: baserun.v1.Template template = 3;
   */
  template?: Template;
}
/**
...
/**
 * @generated from protobuf message baserun.v1.SubmitAnnotationsRequest
 */
export interface SubmitAnnotationsRequest {
  /**
   * @generated from protobuf field: baserun.v1.CompletionAnnotations annotations = 1;
   */
...
class ToolCall$Type extends MessageType<ToolCall> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.ToolFunction function */ 3:
          message.function = ToolFunction.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.function,
  ...
  internalBinaryWrite(
    ...
    if (message.function)
      ToolFunction.internalBinaryWrite(
        message.function,
      ...
      switch (fieldNo) {
        ...
        case /* repeated baserun.v1.ToolCall tool_calls */ 5:
          message.toolCalls.push(
            ToolCall.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
...
class Run$Type extends MessageType<Run> {
  constructor() {
    super('baserun.v1.Run', [
      ...
      },
      {
        ...
        name: 'run_type',
        kind: 'enum',
        T: () => ['baserun.v1.Run.RunType', Run_RunType, 'RUN_TYPE_'],
      },
  ...
  create(value?: PartialMessage<Run>): Run {
    ...
    if (value !== undefined) reflectionMergePartial<Run>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Timestamp start_timestamp */ 7:
          message.startTimestamp = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* google.protobuf.Timestamp completion_timestamp */ 8:
          message.completionTimestamp = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.completionTimestamp,
          );
          break;
        ...
        case /* string session_id */ 11:
          ...
          break;
        case /* optional string environment */ 12:
  ...
  internalBinaryWrite(
    ...
    if (message.environment !== undefined)
      writer.tag(12, WireType.LengthDelimited).string(message.environment);
    const u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
class ModelConfig$Type extends MessageType<ModelConfig> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.Model model */ 3:
          message.model = Model.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.model,
  ...
  internalBinaryWrite(
    ...
    /* float top_p = 8; */
    if (message.topP !== 0) writer.tag(8, WireType.Bit32).float(message.topP);
    /* float top_k = 9; */
    if (message.topK !== 0) writer.tag(9, WireType.Bit32).float(message.topK);
    /* string functions = 10; */
...
class Span$Type extends MessageType<Span> {
  ...
  create(value?: PartialMessage<Span>): Span {
    ...
    if (value !== undefined) reflectionMergePartial<Span>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.Status status */ 7:
          message.status = Status.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status,
        ...
        case /* optional int32 best_of */ 33:
          ...
          break;
        case /* optional string x_request_id */ 47:
        ...
        case /* baserun.v1.EndUser end_user */ 36:
          message.endUser = EndUser.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.endUser,
  ...
  internalBinaryWrite(
    ...
    if (message.xRequestId !== undefined)
      writer.tag(47, WireType.LengthDelimited).string(message.xRequestId);
    ...
    if (message.templateParameters !== undefined)
      writer
        .tag(38, WireType.LengthDelimited)
        .string(message.templateParameters);
...
class Eval$Type extends MessageType<Eval> {
  ...
  create(value?: PartialMessage<Eval>): Eval {
    ...
    if (value !== undefined) reflectionMergePartial<Eval>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
// @generated message type with reflection information, may provide speed optimized methods
class CompletionAnnotations$Type extends MessageType<CompletionAnnotations> {
  constructor() {
    super('baserun.v1.CompletionAnnotations', [
      {
        no: 1,
        name: 'completion_id',
        kind: 'scalar',
  ...
  create(value?: PartialMessage<CompletionAnnotations>): CompletionAnnotations {
    ...
    if (value !== undefined)
      reflectionMergePartial<CompletionAnnotations>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated baserun.v1.Check checks */ 2:
          message.checks.push(
            Check.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
...
/**
 * @generated MessageType for protobuf message baserun.v1.CompletionAnnotations
 */
export const CompletionAnnotations = new CompletionAnnotations$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class Template$Type extends MessageType<Template> {
  constructor() {
    super('baserun.v1.Template', [
      ...
      { no: 2, name: 'name', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'enum',
        T: () => [
          'baserun.v1.Template.TemplateType',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated baserun.v1.TemplateVersion template_versions */ 4:
          message.templateVersions.push(
            TemplateVersion.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
          ...
          break;
        case /* optional baserun.v1.TemplateVersion active_version */ 5:
          message.activeVersion = TemplateVersion.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.templateVersions.length; i++)
      TemplateVersion.internalBinaryWrite(
        message.templateVersions[i],
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* optional baserun.v1.TemplateVersion active_version = 5; */
...
class TemplateVersion$Type extends MessageType<TemplateVersion> {
  ...
  create(value?: PartialMessage<TemplateVersion>): TemplateVersion {
    const message = { id: '', tag: '', templateMessages: [] };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
    });
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.Template template */ 2:
          message.template = Template.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.template,
        ...
        case /* string tag */ 3:
          ...
          break;
        case /* optional string parameter_definition */ 4:
          message.parameterDefinition = reader.string();
          break;
        case /* optional string template_string */ 5:
          message.templateString = reader.string();
          break;
        case /* repeated baserun.v1.TemplateMessage template_messages */ 6:
          message.templateMessages.push(
            TemplateMessage.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    if (message.parameterDefinition !== undefined)
      writer
        .tag(4, WireType.LengthDelimited)
        .string(message.parameterDefinition);
    /* optional string template_string = 5; */
    if (message.templateString !== undefined)
      writer.tag(5, WireType.LengthDelimited).string(message.templateString);
    /* repeated baserun.v1.TemplateMessage template_messages = 6; */
    for (let i = 0; i < message.templateMessages.length; i++)
      TemplateMessage.internalBinaryWrite(
        message.templateMessages[i],
        writer.tag(6, WireType.LengthDelimited).fork(),
        options,
      ).join();
    const u = options.writeUnknownFields;
...
// @generated message type with reflection information, may provide speed optimized methods
class TemplateMessage$Type extends MessageType<TemplateMessage> {
  constructor() {
    super('baserun.v1.TemplateMessage', [
      { no: 1, name: 'id', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        no: 2,
      ...
      { no: 5, name: 'order_index', kind: 'scalar', T: 5 /*ScalarType.INT32*/ },
    ]);
  }
  create(value?: PartialMessage<TemplateMessage>): TemplateMessage {
    const message = { id: '', message: '', role: '', orderIndex: 0 };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
    });
    if (value !== undefined)
      reflectionMergePartial<TemplateMessage>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.TemplateVersion template_version */ 2:
          message.templateVersion = TemplateVersion.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.templateVersion,
  ...
  internalBinaryWrite(
    ...
    if (message.orderIndex !== 0)
      writer.tag(5, WireType.Varint).int32(message.orderIndex);
    const u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
...
/**
 * @generated MessageType for protobuf message baserun.v1.TemplateMessage
 */
export const TemplateMessage = new TemplateMessage$Type();
// @generated message type with reflection information, may provide speed optimized methods
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.Run run */ 1:
          message.run = Run.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.run,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.Log log */ 1:
          message.log = Log.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.log,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.Span span */ 1:
          message.span = Span.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.span,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.Eval eval */ 1:
          message.eval = Eval.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.eval,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.TestSuite test_suite */ 1:
          message.testSuite = TestSuite.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.testSuite,
...
class StartTestSuiteResponse$Type extends MessageType<StartTestSuiteResponse> {
  ...
  create(
    value?: PartialMessage<StartTestSuiteResponse>,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.Session session */ 1:
          message.session = Session.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.session,
...
class SubmitTemplateVersionRequest$Type extends MessageType<SubmitTemplateVersionRequest> {
  ...
  create(
    value?: PartialMessage<SubmitTemplateVersionRequest>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SubmitTemplateVersionRequest>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SubmitTemplateVersionRequest,
  ): SubmitTemplateVersionRequest {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
 ...
 */
export const SubmitTemplateVersionRequest =
  new SubmitTemplateVersionRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitTemplateVersionResponse$Type extends MessageType<SubmitTemplateVersionResponse> {
  ...
  create(
    value?: PartialMessage<SubmitTemplateVersionResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SubmitTemplateVersionResponse>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SubmitTemplateVersionResponse,
  ): SubmitTemplateVersionResponse {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* baserun.v1.TemplateVersion template_version */ 2:
          ...
          break;
        case /* baserun.v1.Template template */ 3:
          message.template = Template.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    /* baserun.v1.Template template = 3; */
    if (message.template)
      Template.internalBinaryWrite(
        message.template,
        writer.tag(3, WireType.LengthDelimited).fork(),
 ...
 */
export const SubmitTemplateVersionResponse =
  new SubmitTemplateVersionResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitModelConfigRequest$Type extends MessageType<SubmitModelConfigRequest> {
  ...
  create(
    value?: PartialMessage<SubmitModelConfigRequest>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SubmitModelConfigRequest,
  ): SubmitModelConfigRequest {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.ModelConfig model_config */ 1:
          message.modelConfig = ModelConfig.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.modelConfig,
  ...
  internalBinaryWrite(
    ...
    if (message.modelConfig)
      ModelConfig.internalBinaryWrite(
        message.modelConfig,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class SubmitModelConfigResponse$Type extends MessageType<SubmitModelConfigResponse> {
  ...
  create(
    value?: PartialMessage<SubmitModelConfigResponse>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SubmitModelConfigResponse,
  ): SubmitModelConfigResponse {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* baserun.v1.EndUser user */ 1:
          message.user = EndUser.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.user,
      ...
      switch (fieldNo) {
        case /* repeated baserun.v1.Template templates */ 1:
          message.templates.push(
            Template.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          const u = options.readUnknownField;
...
// @generated message type with reflection information, may provide speed optimized methods
class SubmitAnnotationsRequest$Type extends MessageType<SubmitAnnotationsRequest> {
  constructor() {
    super('baserun.v1.SubmitAnnotationsRequest', [
      {
        no: 1,
        name: 'annotations',
        kind: 'message',
        T: () => CompletionAnnotations,
      },
      { no: 2, name: 'run', kind: 'message', T: () => Run },
    ]);
  }
  create(
    value?: PartialMessage<SubmitAnnotationsRequest>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SubmitAnnotationsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SubmitAnnotationsRequest,
  ): SubmitAnnotationsRequest {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      const [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* baserun.v1.CompletionAnnotations annotations */ 1:
          message.annotations = CompletionAnnotations.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.annotations,
  ...
  internalBinaryWrite(
    ...
    /* baserun.v1.CompletionAnnotations annotations = 1; */
    if (message.annotations)
      CompletionAnnotations.internalBinaryWrite(
        message.annotations,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
/**
 * @generated MessageType for protobuf message baserun.v1.SubmitAnnotationsRequest
 */
export const SubmitAnnotationsRequest = new SubmitAnnotationsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitAnnotationsResponse$Type extends MessageType<SubmitAnnotationsResponse> {
  constructor() {
    super('baserun.v1.SubmitAnnotationsResponse', [
      { no: 1, name: 'message', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
    ]);
  }
  create(
    value?: PartialMessage<SubmitAnnotationsResponse>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SubmitAnnotationsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SubmitAnnotationsResponse,
  ): SubmitAnnotationsResponse {
    const message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
 ...
 */
export const SubmissionService = new ServiceType(
  'baserun.v1.SubmissionService',
  [
    ...
    { name: 'EndRun', options: {}, I: EndRunRequest, O: EndRunResponse },
    {
      ...
      options: {},
      I: SubmitEvalRequest,
      O: SubmitEvalResponse,
    },
    {
      name: 'StartTestSuite',
      options: {},
      I: StartTestSuiteRequest,
      O: StartTestSuiteResponse,
    },
    {
      name: 'EndTestSuite',
      options: {},
      I: EndTestSuiteRequest,
      O: EndTestSuiteResponse,
    },
    {
      name: 'StartSession',
      options: {},
    ...
    {
      name: 'SubmitTemplateVersion',
      options: {},
      I: SubmitTemplateVersionRequest,
      O: SubmitTemplateVersionResponse,
    },
    {
      name: 'SubmitModelConfig',
      options: {},
      I: SubmitModelConfigRequest,
      O: SubmitModelConfigResponse,
    },
    {
      name: 'SubmitUser',
      options: {},
      I: SubmitUserRequest,
      O: SubmitUserResponse,
    },
    {
      name: 'GetTemplates',
      options: {},
      I: GetTemplatesRequest,
      O: GetTemplatesResponse,
    },
    {
      name: 'SubmitAnnotations',
      options: {},
